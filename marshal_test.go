...
func TestJWT_MarshalText(t *testing.T) {
	...
	tests := []struct {
		...
		{"Normal", JWT{Header{"JWT", "ed25519"}, map[string]string{"name": "test", "use": "testing"}, nil}, []byte("eyJ0eXAiOiJKV1QiLCJhbGciOiJlZDI1NTE5In0.eyJuYW1lIjoidGVzdCIsInVzZSI6InRlc3RpbmcifQ.JPlhN2BUxUsOWV0uwUI03CgVTiQHhDcHQ26ivtJeLWtn_I8dCA2CRZbkuSg_mg-pl-OEyK1OXurQ8PcUGtB5BQ"), false},
	}
